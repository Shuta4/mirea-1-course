...
\setstretch{1}
\lstinputlisting[breaklines=true,breakatwhitespace=true,caption={Тестирование черных клеток},label=lst:test1]{test1.txt}
\lstinputlisting[breaklines=true,breakatwhitespace=true,caption={Тестирование белых клеток},label=lst:test2]{test2.txt}
\lstinputlisting[breaklines=true,breakatwhitespace=true,caption={Тестирование обработки некорректного ввода},label=lst:test3]{test3.txt}
\setstretch{1.5}
